      ...
      <main className="flex-1 px-6 pt-12 lg:pt-16 pb-32">
        <div className="max-w-[600px]">
          <div className="space-y-6 text-[17px] lg:text-[18px] leading-[1.7] text-[#1a1a1a]">
            ...
            <p>
              Our work spans software engineering, AI infrastructure, and product design. We shapeshift between building and researching to solve whatever problems come next.
            </p>
          </div>
        </div>
      </main>
